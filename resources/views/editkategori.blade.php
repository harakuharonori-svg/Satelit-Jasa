...
<head>
    ...
    <title>Edit Kategori - SatelitJasa</title>
...
<body>
    <div class="page-container">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Ubah informasi kategori yang sudah ada</p>
        </div>
        ...
        <div class="form-card">
            <div class="form-header">
                ...
                <h2 class="form-title">Perbarui Kategori</h2>
                <p class="form-description">Modifikasi nama kategori sesuai kebutuhan</p>
            </div>

            <div class="current-value-display">
                <div class="current-label">
                    <i class="fas fa-info-circle me-2"></i>Nilai Saat Ini:
                </div>
                <div class="current-value">{{ $data->nama }}</div>
            </div>

            <form action="{{ route('kategori.update', [$id]) }}" method="post" id="editForm">
                @method("patch")
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="character-count" id="charCount">
                        <span id="currentCount">{{ strlen($data->nama) }}</span>/50 karakter
                    </div>
